...
class Generate_Menu_Page(QMainWindow, Ui_Menu_Form):
    ...
    def CreateSignalSlot(self):
        ...
        # self.dish_reco_result_label.mouseDoubleClickEvent()
...
class CameraRosNode(QThread):
    ...
    def subscriber_topic(self, signal_aruco_send, signal_image_send):
        ...
        rospy.Subscriber('/aruco_single/result', Image, self.callback_aruco_result, (signal_aruco_send,))
        rospy.spin()  # 订阅数据
...
class initial_Worker(QThread):
    ...
    def run(self):
        ...
        rospy.sleep(1.5)
        dual_arm = subprocess.Popen(
            'roslaunch dual_arm_car_grippers_modern_driver dual_arm_car_grippers_metal_publish_alone.launch',
            shell=True)
...
class recognize_start_loc(QThread):
    ...
    def __init__(self, parent=None):
        ...
        self.initial_loc = -0.0827829763293 - 0.027466148
