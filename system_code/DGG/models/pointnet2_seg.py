...
import sys
sys.path.append('/home/robot/PointCloud/pointnet++/Pointnet2.PyTorch-master/utils')
from set_abstraction import PointNet_SA_Module, PointNet_SA_Module_MSG
from feature_propagation import PointNet_FP_Module
...
if __name__ == '__main__':
    in_channels = 3
    n_classes = 4
    l0_xyz = torch.randn(16, 1024, 3)
    l0_points = torch.randn(16, 1024, 0)
